...
def main(seed: int, output_dir: Path = None, visualize: bool = False):
    if output_dir is None:
        output_dir = Path("/scratch/home/smpdp02/coral_lpf_emerge/Coral_new")
    ...
    print(f"Starting HPC simulation for seed={seed}...")
    data = m.mw.run_sweep(parallel=True, n_workers=8, frequency_groups=8, multi_processing=True)
    
    grid = data.scalar.grid
    
    # Export S2P
    s2p_file = s2p_dir / f"{seed}.s2p"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='/scratch/home/smpdp02/coral_lpf_emerge/Coral_new')
